<script>
  ...
  onMount(() => {
    d3.csv("./data/EncuestaVisualizacion.csv", d3.autoType).then(data => {
      console.log(data)
...
<main>
  <div class="header">
    ...
    <h3 class="headline">
      <b>Consumo de Plataformas Online</b>
      Plataformas, contenido y productividad
    </h3>
    <p class="bajada">Explorando los habitos de nuestros alumnos en plataformas online.</p>
  </div>
  ...
  <div class="container">
    ...
    {#each alumnos as alumno}
      <div class="person-container">
        ...
        background-image: radial-gradient(circle, #ffffff 0%, {colorPlataforma(alumno.Plataforma)} 35%);
